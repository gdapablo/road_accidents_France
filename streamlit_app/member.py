class Member:
    ...
    def sidebar_markdown(self):
        ...
        if self.linkedin_url is not None:
            markdown += f' <a href={self.linkedin_url} target="_blank"><img src="https://dst-studio-template.s3.eu-west-3.amazonaws.com/linkedin-logo.png" alt="linkedin" width="20" style="vertical-align: middle; margin-left: 5px"/></a> '
